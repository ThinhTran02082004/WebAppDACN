...
// Sử dụng ảnh từ URL - Có thể thay thế bằng ảnh local nếu cần
const bannerData = [
  {
    id: 1,
  ...
  {
    id: 3,
    imageUrl: 'https://images.unsplash.com/photo-1584515933487-779824d29309?w=400&h=200&fit=crop', 
    title: 'Tiêm vaccine cho trẻ em',
    subtitle: 'Gói khám cao cấp'
  },
  {
    id: 4,
    imageUrl: 'https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=400&h=200&fit=crop', 
