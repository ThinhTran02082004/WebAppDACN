...
export default function ServiceDetailScreen() {
  ...
  const renderDoctorCard = (doctor: Doctor) => (
    ...
    >
      <Image
        source={normalizeImageSource(doctor.user.avatarUrl, 'https://placehold.co/60x60')}
        ...
        >
          ...
          <View style={styles.imageContainer}>
            {service.image || service.imageUrl ? (
              <Image 
                source={normalizeImageSource(service.image || service.imageUrl, 'https://placehold.co/400x300')} 
