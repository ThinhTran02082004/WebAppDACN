      ...
      if (response.success && response.data) {
        ...
        const mockServices = [
          ...
          },
          {
            _id: '2',
            name: 'Xét nghiệm máu',
            description: 'Xét nghiệm các chỉ số cơ bản trong máu',
            price: 150000,
            specialtyId: { _id: '2', name: 'Xét nghiệm' },
            imageUrl: 'https://placehold.co/200x120',
            isActive: true
          },
          {
            _id: '3',
            name: 'Siêu âm tim',
            description: 'Siêu âm tim để kiểm tra chức năng tim',
            price: 300000,
            specialtyId: { _id: '3', name: 'Tim mạch' },
            imageUrl: 'https://placehold.co/200x120',
            isActive: true
          }
        ];
